...
func test35(names []string, initial rune, name string) {
...
func main() {
	test35(getNames5(50), 'M', "Matthew")
	test35(getNames5(100), 'G', "George")
	test35(getNames5(150), 'D', "Drew")
	test35(getNames5(200), 'P', "Philip")
	test35(getNames5(250), 'B', "Bryant")
	test35(getNames5(300), 'M', "Matthew")
}

func getNames5(length int) []string {
	names := []string{
